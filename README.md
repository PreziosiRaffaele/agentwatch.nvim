...
- `:AgentWatch` opens or refreshes a bottom scratch buffer showing agents attached to the current Neovim server, plus resumable `exited` agents from the same project.
